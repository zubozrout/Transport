...
GeneralTranport.stringToObj = function(string) {
...
GeneralTranport.latinise = function(string) {
    if(typeof string !== typeof undefined && (typeof string === "string" || string instanceof String)) {
        var Latinise = {};
...
GeneralTranport.baseString = function(string) {
    string = string || "";
    string = string.toLowerCase();
    string = this.latinise(string);
    return string;
}

GeneralTranport.dateOlderThan = function(oldDate, newDate, difference) {
    if(oldDate && newDate) {
        var hour = 60 * 60 * 1000;
        switch(difference) {
            case "week":
                var week = hour * 24 * 7;
                return newDate - oldDate > week;
            case "day":
                var day = hour * 24;
